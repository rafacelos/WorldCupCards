          ...
          <View style={styles.picture}>

            {
              hasCameraPermission && !photo ?
               ...
               /> : 
              <Image source={{ uri: photo ? photo : 'https://images.gutefrage.net/media/fragen/bilder/meine-kamera-auf-windows-10-funktioniert-nicht-was-tun/0_full.jpg?v=1584606917000' }}
                style={styles.camera}
